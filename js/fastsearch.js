...
document.getElementById("searchBtn1").onclick = function(e) { 
    $("#menu").css("visibility", "hidden")
    doSearch(e)
}
...
function hideSearch() {
    ...
    document.getElementById("searchResults").innerHTML = ""; // remmove results
...
function executeSearch(term) {
  ...
  if (results.length === 0) { // no results based on what was typed into the input box
    ...
    //   console.log('item: %d, title: %s', item, results[item].item.title)
      searchitems = searchitems + '<li><a href="' + results[item].item.permalink + '" tabindex="0">' + '<span>' + results[item].item.title + '</span></a></li>';
